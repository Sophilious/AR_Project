...
![3](https://github.com/Sophilious/Campus_Navigation_System_C.N.S/assets/72597438/0f1c9d34-89b2-451c-b8f9-7e27e78ac568)
   ...
   2. Για τα Markers:
      ...
      Πιο συγκεκριμένα "έκοψα" την εικόνα σε 5 μέρη με επίκεντρο τις ονομασίες των κτηρίων και με την χρήση του προγράμματος "image tracker compiler" της MindAr δημιουργήθηκαν τα Μαρκερς, όστε ανάλογα το σημείο της       
      εικόνας που σκανάρεις να εμφανίζεται η πορεία για το αντίστοιχο κτήριο.
